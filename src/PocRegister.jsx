...
export default function PocRegister({
  C,
  registroInicial = null,
  pocTypeInicial = "Canais Digitais",
  onSaved = null,
  onClose = null,
} = {}) {
  ...
  const metrics = useMemo(
    () => calcMetrics(data.analytics.rows || []),
    [data.analytics.rows],
  );
  ...
  const DayStatus = ({ row }) => {
    ...
    const taxaEntrega =
      totalMensagens > 0 ? (entregue / totalMensagens) * 100 : 0;
    ...
    >
        ...
        data.general.pocType === "Enriquecimento de Dados" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            >
              ...
              <MetricCard
                label="Base recebida"
                value={enrichmentMetrics.baseRecebida}
                sub="Registros enviados"
                color={C.violet}
              />{" "}
              <MetricCard
                label="Base processada"
                value={enrichmentMetrics.baseProcessada}
                sub={pct(enrichmentMetrics.taxaProcessamento)}
                color={C.blue}
              />{" "}
              <MetricCard
                label="Retorno"
                value={enrichmentMetrics.retorno}
                sub={pct(enrichmentMetrics.taxaRetorno)}
                color={C.amber}
              />{" "}
              <MetricCard
                label="CPC novo"
                value={enrichmentMetrics.cpcNovo}
                sub={pct(enrichmentMetrics.taxaCpcNovo)}
                color={C.emerald}
              />{" "}
              <MetricCard
                label="% Meta"
                value={pct(enrichmentMetrics.percentualMeta)}
                sub="Meta de 15%"
                color={
            ...
            <div
              style={{
                height: 4,
                borderRadius: 999,
                background: `linear-gradient(90deg, ${C.violet}, ${C.blue}, ${C.emerald})`,
                opacity: 0.22,
                margin: "2px 0 4px",
              }}
            />{" "}
            ...
            >
              {" "}
              <Section
                title="Resumo da POC de Enriquecimento"
                sub="Leitura da base processada e qualidade do retorno"
              >
                {" "}
                <div
                  style={{
                ...
                >
                  ...
                  {[
                    ...
                    [
                      "Período",
                      `${brDate(data.general.periodStart)} a ${brDate(data.general.periodEnd)}`,
                    ],
                    ["Tipo de POC", "Enriquecimento de Dados"],
                  ].map(([label, value]) => (
                    <div
                      key={label}
                      style={{
              ...
              <Section
                title="Status"
                sub="Decisão atual da POC para acompanhamento"
              >
                {" "}
                <div
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          update("general.status", e.target.value)
                        }
                        style={field}
                      >
                        {" "}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          update("evaluation.recommendation", e.target.value)
                        }
                        style={field}
                      >
                        {" "}
                        <option>Em avaliação</option> <option>Aprovado</option>{" "}
                  ...
                  {(() => {
                    const rec =
                      data.evaluation.recommendation || "Em avaliação";
                    const color =
                      rec === "Aprovado"
                        ? C.emerald
                        : rec === "Reprovado"
                    ...
                    const texto =
                      rec === "Aprovado"
                        ? "POC favorável para evolução do enriquecimento em escala."
                        : rec === "Reprovado"
                          ? "POC não recomendada para continuidade no momento."
                          : rec === "Aprovado com condições"
                            ? "POC favorável, mas depende de ajustes na base, regra de retorno ou validação do fornecedor."
                            : "POC em avaliação. Acompanhar base processada, retorno, CPC novo e atingimento da meta.";
                    return (
                      <div
                        style={{
                          background: bg,
            ...
            <Section
              ...
              sub="Acompanhamento de base, retorno, CPC novo e meta mínima esperada"
            >
              {" "}
              {(() => {
                const funil = [
            ...
            >
              ...
              <Section
                ...
                sub="Pontos de controle da higienização e retorno"
              >
                {" "}
                {[
                  [
                    "Não localizados",
                    enrichmentMetrics.naoLocalizados,
                    C.amber,
                  ],
                  ["Inválidos", enrichmentMetrics.invalidos, C.rose],
                  ["Telefones novos", enrichmentMetrics.telefonesNovos, C.blue],
                  ["E-mails novos", enrichmentMetrics.emailsNovos, C.violet],
              ...
              <Section title="Leitura" sub="Resumo automático para decisão">
                {" "}
                <div style={{ fontSize: 13, color: C.t2, lineHeight: 1.7 }}>
                  {" "}
                  A POC de enriquecimento possui{" "}
                  <strong style={{ color: C.t1 }}>
                    {enrichmentMetrics.baseRecebida}
                  </strong>{" "}
                  registros recebidos, com{" "}
                  <strong style={{ color: C.blue }}>
                    {pct(enrichmentMetrics.taxaProcessamento)}
                  </strong>{" "}
                  de base processada. O CPC novo está em{" "}
                  <strong style={{ color: C.emerald }}>
                    {pct(enrichmentMetrics.taxaCpcNovo)}
                  </strong>
                  , representando{" "}
                  <strong
                    style={{
                  ...
                  >
                    {pct(enrichmentMetrics.percentualMeta)}
                  </strong>{" "}
                  de atingimento da meta de 15%.{" "}
                </div>{" "}
                <button
                ...
                >
                  {" "}
                  Ver relatório de enriquecimento{" "}
                </button>{" "}
              </Section>{" "}
            </div>{" "}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            >
              ...
              <MetricCard
                ...
                sub={pct(metrics.taxaEntrega)}
                color={C.emerald}
              />{" "}
              <MetricCard
                label="Lidos"
                value={metrics.lido}
                sub={pct(metrics.taxaLeituraDisparados)}
                color={C.blue}
              />{" "}
              <MetricCard
                label="Retorno"
                value={metrics.retornoCliente}
                sub={pct(metrics.taxaRetornoLidos)}
                color={C.amber}
              />{" "}
              <MetricCard
                label="Acordos"
                value={metrics.acordos}
                sub={pct(metrics.taxaConversaoFinal)}
                color={C.rose}
              />{" "}
            </div>{" "}
            <div
            ...
            >
              ...
              <Section
                title="Resumo da POC"
                sub="Leitura do teste com fornecedor/produto"
              >
                {" "}
                <div
                  style={{
                ...
                >
                  ...
                  {[
                    ...
                    [
                      "Qtd. disparo por dia",
                      data.general.dailyGoal
                        ? `${data.general.dailyGoal} disparos/dia`
                        : "-",
                    ],
                  ].map(([label, value]) => (
                    <div
                ...
                >
                  ...
                  {(() => {
                    ...
                    const currentIndex = Math.max(
                      0,
                      steps.indexOf(data.general.status || "Em Planejamento"),
                    );
                    return (
                      <div
                        style={{
            ...
            <Section
              title="Funil Drop-off"
              sub="Retenção e perda entre as etapas da jornada da POC"
            >
              {" "}
              {metrics.cliques > metrics.lido && (
                ...
                >
                  ...
                  Cliques acima de Lidos. Validar a regra de contagem do
                  fornecedor antes da apresentação.{" "}
                </div>
              )}{" "}
              {(() => {
                const etapas = [
                  {
                    nome: "Total mensagens",
                    volume: metrics.totalMensagens,
                    base: metrics.totalMensagens,
                    anterior: null,
                    cor: C.violet,
                  },
                  {
                    ...
                    base: metrics.totalMensagens,
                    anterior: metrics.totalMensagens,
                    cor: C.emerald,
                  },
                  {
                    nome: "Lidos",
                  ...
                  },
                  {
                    ...
                    base: metrics.totalMensagens,
                    anterior: metrics.lido,
                    cor: C.cyan,
                  },
                  {
                    nome: "Retorno cliente",
                    volume: metrics.retornoCliente,
                    base: metrics.totalMensagens,
                    anterior: metrics.cliques,
                    cor: C.amber,
                  },
                  {
                    nome: "Acordos",
                    ...
                    base: metrics.totalMensagens,
                    anterior: metrics.retornoCliente,
                    cor: C.rose,
                  },
                ];
                return (
                  ...
                  >
                    ...
                    {etapas.map((etapa, index) => {
                      const percentualBase = etapa.base
                        ? (etapa.volume / etapa.base) * 100
                        : 0;
                      ...
                      const largura = Math.max(
                        0.5,
                        Math.min(100, percentualBase),
                      );
                      const alertaVolumeMaior =
                        etapa.anterior !== null &&
                        etapa.volume > etapa.anterior;
                      return (
                        <div
                          key={etapa.nome}
                          style={{
                          ...
                          >
                            ...
                            <div>
                              ...
                              <div
                                style={{
                                  fontSize: 14,
                                  color: alertaVolumeMaior ? C.amber : C.t1,
                                  fontWeight: 900,
                                }}
                              >
                                {" "}
            ...
            >
              {" "}
              <Section title="Resumo" sub="Análise rápida para liderança">
                {" "}
                <textarea
                  placeholder="Escreva aqui a análise da POC: desempenho geral, principais pontos de atenção, qualidade do fornecedor, comportamento técnico, riscos e recomendação."
                  defaultValue={data.evaluation.executiveSummary}
                  onBlur={(e) =>
                    update("evaluation.executiveSummary", e.target.value)
                  }
                  style={{
                    ...field,
                    minHeight: 120,
              ...
              <Section title="Alertas" sub="Pontos de atenção automáticos">
                {" "}
                {(() => {
                  const incidentes = data.incidents.rows || [];
                  const blockers = data.execution.blockers || [];
                  const criticos = incidentes.filter(
                    (i) => i.severity === "Crítica",
                  ).length;
                  const altas = incidentes.filter(
                    (i) => i.severity === "Alta",
                  ).length;
                  const pendentes = incidentes.filter(
                    (i) => i.status !== "Resolvido" && i.incident,
                  ).length;
                  const bloqueiosAbertos = blockers.filter(
                    (b) => b.status !== "Resolvido" && b.blocker,
                  ).length;
                  const alertas = [
                    {
                    ...
                    {
                      label: "Incidentes alta severidade",
                      value: altas,
                      severity: "high",
                    },
                    {
                    ...
                    {
                      label: "Bloqueios em aberto",
                      value: bloqueiosAbertos,
                      severity: "critical",
                    },
                  ];
                  return (
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              borderRadius: 12,
                              padding: "11px 13px",
                              animation: hasProblem
                                ? "pocPulseAlert 1.8s infinite"
                                : "none",
                            }}
                          >
                            {" "}
      ...
      {tab === "general" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {" "}
          <Section
            title="Informações Gerais da POC"
            sub="Dados de alinhamento inicial com o fornecedor e acompanhamento"
          >
            {" "}
            <div
              style={{
            ...
            >
              ...
              >
                {" "}
                <option>Em Planejamento</option> <option>Em Execução</option>{" "}
                <option>Em Monitoramento</option>{" "}
                <option>Encerrada</option>{" "}
              </select>{" "}
            </div>{" "}
          ...
          >
            ...
            >
              ...
              <textarea
                ...
                onBlur={(e) =>
                  update("planning.businessProblem", e.target.value)
                }
                style={{
                  ...field,
                  minHeight: 130,
                  ...
                  {data.planning.successCriteria.map((row) => (
                    <tr key={row.id}>
                      ...
                      <td style={{ padding: 6 }}>
                        ...
                        >
                          {" "}
                          <option>Pendente</option> <option>Atendido</option>{" "}
                      ...
                      <td style={{ padding: 6 }}>
                        ...
                        <button
                          onClick={() =>
                            removeRow("planning", "successCriteria", row.id)
                          }
                          style={{ ...smallField, cursor: "pointer" }}
                        >
                          {" "}
              ...
              >
                ...
                <thead>
                  ...
                  <tr>
                    {" "}
                    {[
                      "Atividade / Caso de Teste",
                      "Responsável",
                      "Status",
                      "Notas de evolução / comportamento",
                      "",
                    ].map((h) => (
                      <th
                        key={h}
                ...
                <tbody>
                  {" "}
                  {(data.general.pocType === "Enriquecimento de Dados"
                    ? (data.execution.activities || []).filter(
                        (row) =>
                          ![
                            "Instalação, setup de infra e configuração inicial",
                            "Testes de carga e performance",
                            "Validação de integrações com sistemas legados",
                            "Testes de homologação pelo usuário (UAT)",
                          ].includes(row?.activity || ""),
                      )
                    : data.execution.activities || []
                  ).map((row) => (
                    <tr key={row.id}>
                      {" "}
                      <td style={{ padding: 6 }}>
                      ...
                      <td style={{ padding: 6 }}>
                        ...
                        <button
                          onClick={() =>
                            removeRow("execution", "activities", row.id)
                          }
                          style={{ ...smallField, cursor: "pointer" }}
                        >
                          {" "}
        ...
        data.general.pocType === "Enriquecimento de Dados" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              <MetricCard
                label="Enriquecidos"
                value={enrichmentMetrics.registrosEnriquecidos}
                sub={pct(enrichmentMetrics.taxaEnriquecimento)}
                color={C.emerald}
              />{" "}
            </div>{" "}
            <Section
                ...
                >
                  ...
                  <tbody>
                    ...
                    {(data.enrichment?.rows || []).map((row) => {
                      ...
                      const txEnriquecimento =
                        baseProcessada > 0
                          ? (enriquecidos / baseProcessada) * 100
                          : 0;
                      return (
                        <tr
                          key={row.id}
                        ...
                        >
                          ...
                          <td style={{ padding: 6 }}>
                            ...
                            <button
                              onClick={() =>
                                removeRow("enrichment", "rows", row.id)
                              }
                              style={{ ...smallField, cursor: "pointer" }}
                            >
                              {" "}
                    ...
                    >
                      ...
                      >
                        {enrichmentMetrics.baseProcessada}
                      </td>{" "}
                      <td
                        style={{
                          padding: "12px 8px",
                      ...
                      >
                        {enrichmentMetrics.registrosEnriquecidos}
                      </td>{" "}
                      <td
                        style={{
                          padding: "12px 8px",
                      ...
                      >
                        {enrichmentMetrics.telefonesNovos}
                      </td>{" "}
                      <td
                        style={{
                          padding: "12px 8px",
                      ...
                      >
                        {pct(enrichmentMetrics.taxaEnriquecimento)}
                      </td>{" "}
                      <td />{" "}
                    </tr>{" "}
                  </tbody>{" "}
            ...
            <Section
              title="Funil do Enriquecimento"
              sub="Visão dos principais percentuais da POC de enriquecimento de dados"
            >
              {" "}
              {(() => {
                const funil = [
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                >
                  ...
                  <tbody>
                    ...
                    {data.analytics.rows.map((row) => {
                      ...
                      const txEntrega =
                        totalMensagens > 0
                          ? (entregue / totalMensagens) * 100
                          : 0;
                      const txLeitura =
                        entregue > 0 ? (lido / entregue) * 100 : 0;
                      return (
                        <tr
                          key={row.id}
                          style={{ borderBottom: `1px solid ${C.border}` }}
                        >
                          ...
                          <td style={{ padding: 6 }}>
                            ...
                            <button
                              onClick={() =>
                                removeRow("analytics", "rows", row.id)
                              }
                              style={{ ...smallField, cursor: "pointer" }}
                            >
                              {" "}
                    ...
                    >
                      ...
                      >
                        {pct(metrics.taxaLeituraEntregues)}
                      </td>{" "}
                      <td
                        style={{
                          padding: "12px 8px",
            ...
            >
              ...
              <Section
                ...
                sub="Base do funil: Total de mensagens. Percentuais calculados conforme regra de negócio da POC"
              >
                {" "}
                <div style={{ overflowX: "auto" }}>
                  {" "}
                      ...
                      {(() => {
                        ...
                        const etapas = [
                          ...
                          },
                          {
                            ...
                            volume: metrics.entregue,
                            anterior: baseFunil
                              ? (metrics.entregue / baseFunil) * 100
                              : 0,
                            disparados: baseFunil
                              ? (metrics.entregue / baseFunil) * 100
                              : 0,
                          ...
                          },
                          {
                            ...
                            volume: metrics.lido,
                            anterior: metrics.entregue
                              ? (metrics.lido / metrics.entregue) * 100
                              : 0,
                            disparados: baseFunil
                              ? (metrics.lido / baseFunil) * 100
                              : 0,
                            obs: "Lido / Entregue",
                          },
                          {
                            ...
                            volume: metrics.cliques,
                            anterior: metrics.lido
                              ? (metrics.cliques / metrics.lido) * 100
                              : 0,
                            disparados: baseFunil
                              ? (metrics.cliques / baseFunil) * 100
                              : 0,
                            obs: "Clique / Lido",
                          },
                          {
                            ...
                            volume: metrics.retornoCliente,
                            anterior: metrics.cliques
                              ? (metrics.retornoCliente / metrics.cliques) * 100
                              : 0,
                            disparados: baseFunil
                              ? (metrics.retornoCliente / baseFunil) * 100
                              : 0,
                            obs: "Retorno / Clique",
                          },
                          {
                            ...
                            volume: metrics.acordos,
                            anterior: metrics.retornoCliente
                              ? (metrics.acordos / metrics.retornoCliente) * 100
                              : 0,
                            disparados: baseFunil
                              ? (metrics.acordos / baseFunil) * 100
                              : 0,
                            obs: "Acordo / Retorno",
                          },
                        ];
              ...
              <Section
                title="Indicadores"
                sub="Resumo automático da performance da POC"
              >
                {" "}
                {[
                  ["Taxa de entrega geral", metrics.taxaEntrega, C.emerald],
                  [
                    "Taxa de leitura s/ entregues",
                    metrics.taxaLeituraEntregues,
                    C.blue,
                  ],
                  [
                    "Taxa de leitura s/ disparados",
                    metrics.taxaLeituraDisparados,
                    C.violet,
                  ],
                  [
                    "Taxa de retorno s/ lidos",
                    metrics.taxaRetornoLidos,
                    C.amber,
                  ],
                  [
                    "Taxa de conversão final",
                    metrics.taxaConversaoFinal,
                    C.rose,
                  ],
                ].map(([label, value, color]) => (
                  <div
      ...
      {tab === "incidents" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {" "}
          <Section
            title="Registro de Impedimentos"
            sub="Justificativa de atrasos e dependências"
          >
            {" "}
            {(data.execution.blockers || []).map((row) => (
              <div
                ...
                style={{
                  display: "grid",
                  gridTemplateColumns: "150px 1fr 180px 110px 130px 90px",
                  gap: 8,
                  marginBottom: 8,
                }}
              >
                ...
                <button
                  onClick={() => removeRow("execution", "blockers", row.id)}
                  style={{ ...smallField, cursor: "pointer" }}
                >
                  Excluir
                </button>{" "}
            ...
            <button
              ...
              style={{ ...field, cursor: "pointer", fontWeight: 800 }}
            >
              + Adicionar impedimento
            </button>{" "}
          </Section>{" "}
          <Section
            title="Log de Erros e Incidentes"
            sub="Controle de severidade, causa raiz, solução e horas paradas"
          >
            {" "}
            <div style={{ overflowX: "auto" }}>
              {" "}
                ...
                <tbody>
                  ...
                  {data.incidents.rows.map((row) => (
                    <tr key={row.id}>
                      ...
                      <td style={{ padding: 6 }}>
                        <button
                          onClick={() => removeRow("incidents", "rows", row.id)}
                          style={{ ...smallField, cursor: "pointer" }}
                        >
                          Excluir
                        </button>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {(() => {
            ...
            const defaultDecommissioning = [
              ...
              {
                key: "dataPurged",
                label: "Dados de teste expurgados",
                checked: false,
              },
              {
                key: "residualDataValidated",
            ...
            const planningKpis = (data.planning?.successCriteria || []).filter(
              (kpi) => kpi.kpi,
            );
            const savedKpis = evaluation.kpiResults || [];
            const kpiRows = planningKpis.map((kpi, index) => {
              const saved =
                savedKpis.find((item) => item.kpiId === kpi.id) || {};
              const statusBase =
                kpi.status === "Atendido"
                  ? 100
                  : kpi.status === "Parcial"
            ...
            const evaluatedKpis = kpiRows.filter(
              (item) =>
                item.attainment !== "" &&
                item.attainment !== null &&
                item.attainment !== undefined,
            );
            const totalWeight = evaluatedKpis.reduce(
              (acc, item) => acc + Math.max(0, toNum(item.weight || 1)),
              0,
            );
            const weightedScore5 = totalWeight
              ? evaluatedKpis.reduce(
                  (acc, item) =>
                    acc +
                    gradeFromAttainment(item.attainment) *
                      Math.max(0, toNum(item.weight || 1)),
                  0,
                ) / totalWeight
              : 0;
            const score10 = weightedScore5 * 2;
            const kpiCompletion = planningKpis.length
              ? (evaluatedKpis.length / planningKpis.length) * 100
              : 0;
            const savedDealBreakers = evaluation.dealBreakers || [];
            const dealBreakers = defaultDealBreakers.map((item) => ({
              ...item,
              checked: Boolean(
                savedDealBreakers.find((saved) => saved.key === item.key)
                  ?.checked,
              ),
            }));
            ...
            const qualitative = {
              ...
              technicalCapacity:
                evaluation.qualitative?.technicalCapacity || "0",
              documentation: evaluation.qualitative?.documentation || "0",
              implementationEase:
                evaluation.qualitative?.implementationEase || "0",
            };
            ...
            const decommissioning = defaultDecommissioning.map((item) => ({
              ...
              checked:
                Boolean(
                  savedDecommissioning.find((saved) => saved.key === item.key)
                    ?.checked,
            ...
            function updateEvaluationPatch(patch) {
              ...
              setData((prev) => {
                const next = cloneData(prev);
                next.evaluation = { ...(next.evaluation || {}), ...patch };
                return next;
              });
            }
            ...
            function updateDealBreaker(key, checked) {
              ...
              setData((prev) => {
                ...
                const current = defaultDealBreakers.map((item) => {
                  const saved = (next.evaluation?.dealBreakers || []).find(
                    (d) => d.key === item.key,
                  );
            ...
            function updateDecommissioning(key, checked) {
              ...
              setData((prev) => {
                ...
                const current = defaultDecommissioning.map((item) => {
                  const saved = (next.evaluation?.decommissioning || []).find(
                    (d) => d.key === item.key,
                  );
                  return {
                    ...item,
                    checked:
                      ...
                      Boolean(next.evaluation?.[item.key]),
                  };
                });
                const updated = current.map((item) =>
                  item.key === key ? { ...item, checked } : item,
            ...
            return (
              <>
                {" "}
                <Section
                  title="Score Final da POC"
                  sub="Resultado ponderado calculado a partir dos KPIs, deal-breakers e critérios avaliados"
                >
                  {" "}
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: "190px 0.75fr 1fr",
                      gap: 14,
                      alignItems: "stretch",
                    }}
                  >
                    ...
                    <div
                      style={{
                        background: hasDealBreaker
                          ? C.roseGlow || "rgba(239,68,68,0.10)"
                          : C.bg3,
                        border: `1px solid ${hasDealBreaker ? C.rose : C.border}`,
                        borderRadius: 14,
                        padding: 14,
                        animation: hasDealBreaker
                          ? "pocPulseAlert 1.6s infinite"
                          : "none",
                      }}
                    >
                      {" "}
                    ...
                    >
                      ...
                      <div style={{ fontSize: 12, color: C.t2, marginTop: 8 }}>
                        {" "}
                        {pct(kpiCompletion)} dos critérios com resultado
                        informado{" "}
                      </div>{" "}
                    </div>{" "}
                    <div
                ...
                <Section
                  ...
                  sub="KPIs vindos do Planejamento. Preencha o resultado alcançado e o atingimento para cálculo automático do score"
                >
                  {" "}
                  {kpiRows.length === 0 ? (
                    <div
                    ...
                    >
                      {" "}
                      Nenhum KPI cadastrado ainda. Vá em Planejamento e adicione
                      os critérios de sucesso da POC.{" "}
                    </div>
                  ) : (
                    <div style={{ overflowX: "auto" }}>
                      {" "}
                ...
                <Section
                  title="Deal-breakers"
                  sub="Critérios de reprovação automática. Se qualquer item for marcado, a aprovação fica bloqueada independente do score"
                >
                  {" "}
                  <div
                    style={{
                  ...
                  >
                    ...
                    {dealBreakers.map((item) => (
                      <button
                        key={item.key}
                        onClick={() =>
                          updateDealBreaker(item.key, !item.checked)
                        }
                        style={{
                          textAlign: "left",
                ...
                >
                  ...
                  <Section
                    ...
                    sub="Contexto da performance: fornecedor vs. operação atual"
                  >
                    {" "}
                    <div
                      style={{
                    ...
                    >
                      {" "}
                      <input
                        placeholder="Entrega atual / baseline %"
                        defaultValue={baseline.currentDelivery || ""}
                        onBlur={(e) =>
                          updateBaseline("currentDelivery", e.target.value)
                        }
                        style={field}
                      />{" "}
                      <input
                        placeholder="Entrega fornecedor %"
                        defaultValue={baseline.supplierDelivery || ""}
                        onBlur={(e) =>
                          updateBaseline("supplierDelivery", e.target.value)
                        }
                        style={field}
                      />{" "}
                      <input
                        placeholder="Leitura atual / baseline %"
                        defaultValue={baseline.currentReading || ""}
                        onBlur={(e) =>
                          updateBaseline("currentReading", e.target.value)
                        }
                        style={field}
                      />{" "}
                      <input
                        placeholder="Leitura fornecedor %"
                        defaultValue={baseline.supplierReading || ""}
                        onBlur={(e) =>
                          updateBaseline("supplierReading", e.target.value)
                        }
                        style={field}
                      />{" "}
                      <input
                        placeholder="Conversão atual / baseline %"
                        defaultValue={baseline.currentConversion || ""}
                        onBlur={(e) =>
                          updateBaseline("currentConversion", e.target.value)
                        }
                        style={field}
                      />{" "}
                      <input
                        placeholder="Conversão fornecedor %"
                        defaultValue={baseline.supplierConversion || ""}
                        onBlur={(e) =>
                          updateBaseline("supplierConversion", e.target.value)
                        }
                        style={field}
                      />{" "}
                    </div>{" "}
                  ...
                  <Section
                    ...
                    sub="Dimensões que afetam contratação e operação no longo prazo"
                  >
                    {" "}
                    <div
                      style={{
                    ...
                    >
                      ...
                      {qualitativeItems.map(([key, label]) => (
                        <div key={key}>
                          ...
                          >
                            {" "}
                            <span style={{ color: C.t2, fontWeight: 800 }}>
                              {label}
                            </span>{" "}
                            <strong style={{ color: C.blue }}>
                              {qualitative[key]}/5
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateQualitative(key, e.target.value)
                            }
                            style={{ width: "100%" }}
                          />{" "}
                        </div>
                ...
                <Section
                  ...
                  sub="Decisão formal com justificativa, responsável, data e aprovação da liderança"
                >
                  {" "}
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: "1fr 1fr 180px 220px",
                      gap: 12,
                      marginBottom: 12,
                    }}
                  >
                    ...
                    <input
                      ...
                      onBlur={(e) =>
                        updateEvaluationPatch({
                          recommendationOwner: e.target.value,
                        })
                      }
                      style={field}
                    />{" "}
                    <input
                      ...
                      onBlur={(e) =>
                        updateEvaluationPatch({
                          recommendationDate: e.target.value,
                        })
                      }
                      style={field}
                    />{" "}
                    <select
                      ...
                      onChange={(e) =>
                        updateEvaluationPatch({
                          leadershipApproval: e.target.value,
                        })
                      }
                      style={field}
                    >
                  ...
                  />{" "}
                  {(evaluation.recommendation || "Em avaliação") ===
                    ...
                    <textarea
                      ...
                      onBlur={(e) =>
                        updateEvaluationPatch({ conditions: e.target.value })
                      }
                      style={{
                        ...field,
                        minHeight: 100,
                  ...
                  {(evaluation.recommendation || "Em avaliação") !==
                    "Em avaliação" &&
                    !evaluation.recommendationJustification && (
                      <div
                        style={{
                          marginTop: 12,
                          background: C.amberGlow,
                      ...
                      >
                        {" "}
                        A recomendação precisa de justificativa escrita para
                        rastreabilidade da decisão.{" "}
                      </div>
                    )}{" "}
                </Section>{" "}
                <Section
                  title="Descomissionamento e Encerramento Seguro"
                  sub="Checklist ampliado para encerramento seguro da POC"
                >
                  {" "}
                  <div
                    style={{
                    ...
                    {decommissioning.map((item) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateDecommissioning(item.key, e.target.checked)
                          }
                        />{" "}
                        {item.label}{" "}
                      </label>
